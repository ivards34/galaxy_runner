...
from galaxy_runner.ui import SCREEN_HEIGHT
...
class PowerUp:
    ...
    def __init__(self, x: int, y: int, powerup_type: str = None):
        ...
        try:
            ...
            img_map = {
                'health': os.path.join(base_dir,  'res', 'img', 'powerup_health.png'),
                'rapid_fire': os.path.join(base_dir,  'res', 'img', 'powerup_rapid_fire.png'),
                'shield': os.path.join(base_dir,  'res', 'img', 'powerup_shield.png'),
            }
