...
from galaxy_runner.ui import PLAYER_SPEED, PROJECTILE_SPEED, SCREEN_WIDTH, SCREEN_HEIGHT
...
class Player:
    def __init__(self, x: int, y: int):
        ...
        self.shoot_delay = 0.3  # segundos entre disparos
        ...
        self.sprint_duration_time = 0.4  # Duración del sprint
        ...
        try:
            ...
            img_center = os.path.join(base_dir,  'res', 'img', 'player.png')
            img_left = os.path.join(base_dir,  'res', 'img', 'player_izquierda.png')
            img_right = os.path.join(base_dir,  'res', 'img', 'player_derecha.png')
