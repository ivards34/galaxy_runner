...
from constants.config import DB_PATH, SCREEN_WIDTH, SCREEN_HEIGHT, FPS
from scenes import StartMenuScene, GameScene, LeaderboardScene, OptionsScene, CreditsScene
from scenes.game_over_scene import GameOverScene
from service import AudioManager
